...
/*   Updated: 2018/12/10 14:21:01 by erli             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int		max_power(double nb, double *pow, int precision)
{
	int len;
...
static	void	fill_decimals(double nb, char *str, int i, int precision)
{
	int pow;
